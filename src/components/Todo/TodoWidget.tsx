...
type Todo = {
  ...
  dueDate: string | null; // comes back JSON serialized
...
export default function TodoWidget() {
  ...
  return (
    <section
      className={[
        // Grid placement: tweak these spans to fit your layout
                  ...
                  <div className="flex-1 min-w-0">
                    <div
                      className={[
                        ...
                        t.completed ? "text-ctp-subtext0 line-through" : "text-ctp-text",
                      ].join(" ")}
                      title={t.title}
                    >
                      {t.title}
